...
//   var labelsChart = dataChart.map((vData) => vData.day);
...
//     if(dataChart) {
//       labelsChart = dataChart.map((vData) => vData.day);
//     },
//     labels: labelsChart,
//     datasets: [
//       {
...
function LineChart() {
  ...
  const labelsChart = dataChart.map((vData) => vData.day);
